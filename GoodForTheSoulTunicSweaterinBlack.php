...
<div id="DesignerJacket"><div class="picZoomer">
        <img src="img/women/31.jpg" height="700" width="400" alt="">
    </div>

    <ul class="piclist">
        <li><img src="img/women/32.jpg" alt=""></li>
        <li><img src="img/women/33.jpg" alt=""></li>
 ...
 <div id="detailsproduct">
    <p style="font-size:36px; font-family:'Trebuchet MS', Arial, Helvetica, sans-serif; font-weight:bold;"> Good For The Soul Tunic Sweater in Black<span style="font-family:'Trebuchet MS', Arial, Helvetica, sans-serif; font-size:16px;"> $39.00</span></p>
