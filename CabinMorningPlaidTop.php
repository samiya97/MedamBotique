...
<div id="DesignerJacket"><div class="picZoomer">
        <img src="img/women/34.jpg" height="700" width="400" alt="">
    </div>

    <ul class="piclist">
        <li><img src="img/women/35.jpg" alt=""></li>
        <li><img src="img/women/36.jpg" alt=""></li>
 ...
 <div id="detailsproduct">
    <p style="font-size:36px; font-family:'Trebuchet MS', Arial, Helvetica, sans-serif; font-weight:bold;"> Cabin Morning Plaid Top<span style="font-family:'Trebuchet MS', Arial, Helvetica, sans-serif; font-size:16px;"> $42.00</span></p>
    <h2 style="font-weight:bold; font-family:'Palatino Linotype', 'Book Antiqua', Palatino, serif"> Product details </h2>
    <p style="font-family:'Trebuchet MS', Arial, Helvetica, sans-serif; font-size:18px;">FABRIC: leather stuff</p>
