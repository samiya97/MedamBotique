...
<div id="DesignerJacket"><div class="picZoomer">
        <img src="img/women/22.jpg" height="700" width="400" alt="">
    </div>

    <ul class="piclist">
        <li><img src="img/women/24.jpg" alt=""></li>
        <li><img src="img/women/23.jpg" alt=""></li>
 ...
 <div id="detailsproduct">
    <p style="font-size:36px; font-family:'Trebuchet MS', Arial, Helvetica, sans-serif; font-weight:bold;"> Autumn Crisp Lightweight Jacket<span style="font-family:'Trebuchet MS', Arial, Helvetica, sans-serif; font-size:16px;"> $39.00</span></p>
