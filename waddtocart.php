...
for($i = 0 ; $i < count($_SESSION['cart']); $i++){
 $a= $_SESSION['cart'][$i];
  $sql = "SELECT * FROM women WHERE id = '$a'";
...
<td class="col-md-1" ><?php echo $dress[$i]["dressname"]; ?> </td>
...
<td class="col-md-2" >SubTotal(<?php echo $total ?>)<br /><a href="women.php">Add more</a>
<br /><a href="wDeliver.php">Deliver</a></td>
</tr>
</table>
