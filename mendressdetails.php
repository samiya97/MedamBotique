...
<title>Men Dress</title><link rel="shortcut icon" href="logo/12.png">
...
$ID = $_GET['id'];
 ...
 $_SESSION['Addss'] = "Men";
		$sql1 = "Select * from men where id = '$ID'";
...
<div id="DesignerJacket">
    ...
    <p style="font-size:36px; font-family:'Trebuchet MS', Arial, Helvetica, sans-serif; font-weight:bold;"> <?php echo $row1["dress_name"]; ?> <span style="font-family:'Trebuchet MS', Arial, Helvetica, sans-serif; font-size:16px;"> PKR <?php echo $row1["price"]; ?> </span></p>
...
<?php echo $row1["product_detailes"]; ?>
    ...
    for($i=0;$i<count($size);$i++){
     ...
     ?> </p>
    <h2   style="font-weight:bold; font-family:'Palatino Linotype', 'Book Antiqua', Palatino, serif;"> Color </h2>
    <p style="font-family:'Trebuchet MS', Arial, Helvetica, sans-serif; font-family:21px;"> 
    <?php 
    $str = $row1["color"];
    $size = explode(",",$str);
    for($i=0;$i<count($size);$i++){
